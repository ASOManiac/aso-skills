...
```bash
aso keywords analyze <user_top_keyword> --storefront <SF> --exclude topApps,relatedSearches,totalApps
```
...
```bash
aso keywords analyze <competitor_unique_keywords> --storefront <SF> --exclude topApps,relatedSearches,totalApps
```

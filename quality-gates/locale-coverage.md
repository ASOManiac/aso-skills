...
1. Identify unfilled locales with `aso metadata pull --app <appId> --version "<CURRENT_VERSION>" --dir ./metadata`
...
4. Deploy with `aso metadata push --app <appId> --version "<CURRENT_VERSION>" --dir ./metadata` or Fastlane
